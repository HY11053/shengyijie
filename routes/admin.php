...
Route::group(['prefix' => 'admin'],function ()
{
    ...
    Route::get('article/knowledges','ArticleController@KnowLedges');
    Route::get('article/knowledges/ownership','ArticleController@OwnerKnowledgeShip');
    Route::get('article/knowledges/pendingaudit','ArticleController@PendingAuditKnowledge');
    Route::get('article/knowledges/pedingpublished','ArticleController@PedingKnowledges');
    Route::get('article/knowlede/create','ArticleController@KnowLedgeCreate');
    Route::post('article/knowlede/create','ArticleController@PostKnowLedgeCreate')->name('knowlede_create');
    Route::get('article/knowlede/edit/{id}','ArticleController@KnowLedgeEdit');
    Route::put('article/knowlede/edit/{id}','ArticleController@PostKnowLedgeEdit')->name('knowlede_edit');
    Route::post('article/knowlede/delete/{id}','ArticleController@DeleteKnowLedgeArticle');
    ...
    Route::post('brandnamestatus','ArticleRealtionController@BrandNameStatus');
});
