...
{
    protected $guarded = ['imagepic','xiongzhang','updatetime','image','indexlitpic','input-image','imagepic','topid','texuid','brandphone','ppjstitle','brandcid','webname','bdname'];
    ...
    public function getBrandnameAttribute($brandname)
    {
        return str_replace('加盟','',$brandname).'加盟';
    }
