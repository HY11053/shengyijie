                ...
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <div class="pull-right" style="display:inline-block; width: 210px">
                            <a href="{{action('Admin\ArticleController@KnowLedgeCreate')}}" style="color: #ffffff ; display: inline-block; padding-left: 3px;"><button  class="btn btn-sm btn-default bg-blue"><i class="fa  fa-pencil-square" style="padding-right: 3px;"></i>添加知识</button></a>
                        ...
                        <form action="/admin/brand_search" method="post" class="form-group pull-right col-md-2 col-xs-6">
                            <div class="input-group input-group-sm ">
                                <input type="text" name="title" class="form-control pull-right" placeholder="知识文档搜索">
                                {{csrf_field()}}
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($articles as $article)
                            <tr>
                                ...
                                <td class="astyle"><span class="label label-success"><a href="/zhishi/{{$article->id}}" target="_blank">预览</a></span><span class="label label-warning"><a href="/admin/article/knowlede/edit/{{$article->id}}">编辑</a></span><span class="label label-danger"><a data-toggle="modal" data-target=".modal-sm{{$article->id}}" >删除</a></span>
    ...
    <script>
        ...
        function AjDelete (id,node) {
            ...
            $.ajax({
                ...
                type:"POST",
                //提交的网址
                url:"/admin/article/knowlede/delete/"+id,
                //提交的数据
